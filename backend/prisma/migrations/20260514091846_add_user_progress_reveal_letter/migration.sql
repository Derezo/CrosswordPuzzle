...
CREATE TABLE "new_user_progress" (
    ...
    "revealedCells" TEXT NOT NULL DEFAULT '{}',
    "usedHints" BOOLEAN NOT NULL DEFAULT false,
    "lastRevealAt" DATETIME,
    "dailyRevealCount" INTEGER NOT NULL DEFAULT 0,
