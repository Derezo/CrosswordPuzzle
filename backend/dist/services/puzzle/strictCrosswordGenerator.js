            ...
            for (let c = 0; c <= GRID_SIZE; c++) {
                ...
                if (!isEnd) {
                    ...
                    if (!processedWords.has(key)) {
                        ...
                        const placedWord = this.placedWords.find(w => w.row === r && w.col === startCol && w.direction === 'across' && w.word === word);
                        if (placedWord) {
                            clues.push({
            ...
            for (let r = 0; r <= GRID_SIZE; r++) {
                ...
                if (!isEnd) {
                    ...
                    if (!processedWords.has(key)) {
                        processedWords.add(key);
                        // Find matching placed word
                        const placedWord = this.placedWords.find(w => w.row === startRow && w.col === c && w.direction === 'down' && w.word === word);
                        if (placedWord) {
                            clues.push({
